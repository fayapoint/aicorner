    ...
    <div className="max-w-2xl mx-auto py-16 px-4">
      ...
      <div className="space-y-8">
        <div className="bg-white/5 rounded-xl p-6 border border-slate-700/40 shadow-lg">
          ...
          <Link href="/carreiras/fullstack" className="inline-block font-semibold text-purple-300 hover:text-white underline transition">Saiba mais &rarr;</Link>
        </div>
        <div className="bg-white/5 rounded-xl p-6 border border-slate-700/40 shadow-lg">
          ...
          <Link href="/carreiras/designer" className="inline-block font-semibold text-pink-300 hover:text-white underline transition">Saiba mais &rarr;</Link>
        </div>
        <div className="bg-white/5 rounded-xl p-6 border border-slate-700/40 shadow-lg">
          ...
          <Link href="/carreiras/cloud" className="inline-block font-semibold text-blue-300 hover:text-white underline transition">Saiba mais &rarr;</Link>
        </div>
      </div>
    </div>
  );
